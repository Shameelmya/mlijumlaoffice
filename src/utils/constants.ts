...
export const MORAL_QUOTES = [
  ...
  "പാവപ്പെട്ടവരുടെ ഉന്നമനമാണ് ഒരു സർക്കാരിന്റെ യഥാർത്ഥ ലക്ഷ്യം. - കാൾ മാർക്സ്",
  ...
  "ചരിത്രം തിരുത്തപ്പെടുന്നത് ജനങ്ങളുടെ പോരാട്ടങ്ങളിലൂടെയാണ്. - ചെ ഗുവേര",
  ...
  "രാഷ്ട്രീയം എന്നത് സമൂഹത്തെ മാറ്റിമറിക്കാനുള്ള ഒരു ഉപകരണമാണ്. - ഇ.എം.എസ് നമ്പൂതിരിപ്പാട്",
  ...
  "സത്യം എപ്പോഴും വിപ്ലവകരമാണ്. - അന്റോണിയോ ഗ്രാംഷി"
];
